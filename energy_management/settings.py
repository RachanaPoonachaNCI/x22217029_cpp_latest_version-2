...
# Application definition for applications deployed
...
#s3 bucket credentials retrieved by importing config file which has environment variables defined here
